...
##########################################################################################################
##########################################################################################################
class MyPrintReubenPython2and3Class(Frame): #Subclass the Tkinter Frame

    def __init__(self, setup_dict):

        print("#################### MyPrintReubenPython2and3Class __init__ starting. ####################")
        ...
        if "LogFileNameFullPath" in setup_dict:
            ...
            if self.LogFileNameFullPath.find("/") == -1 and self.LogFileNameFullPath.find("\\") == -1:
                print("MyPrintReubenPython2and3Class __init__ error: 'LogFileNameFullPath' must be FULL path (should include slashes).")
                return
        ...
        print("#################### MyPrintReubenPython2and3Class __init__ ended input-parameter parsing and variable initialization. ####################")
    ...
    def MainDataWritingThread(self):
        ...
        self.my_print("Started the MainDataWritingThread for MyPrintReubenPython2and3Class object.")
        ...
        print("Exited the main thread for MyPrintReubenPython2and3Class object.")
    ##########################################################################################################
    ##########################################################################################################
    ...
    def ExitProgram_Callback(self):
        ...
        print("Exiting all threads for MyPrintReubenPython2and3Class.")
    ...
    def GUI_Thread(self, parent=None):
        ...
        print("Starting the GUI_Thread for MyPrintReubenPython2and3Class object.")
