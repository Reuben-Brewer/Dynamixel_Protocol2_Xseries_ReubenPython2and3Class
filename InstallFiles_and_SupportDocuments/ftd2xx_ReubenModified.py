...
elif sys.platform == 'linux': #Reuben added this line to make this module work with Python 3
    from . import _ftd2xx_linux as _ft #Reuben added this line to make this module work with Python 3
